...
Data = load("/media/navar/Dados/Mestrado/Mestrado/MP-Safety ITA/Conjuntos de dados/PHM08 - NASA/Conjunto de dados/final_test.txt");
...
filename = 'PHM08_OC_01_4Class_finaltestSet__v000.csv'
mkdir Dataset
